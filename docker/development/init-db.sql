...
SELECT 'CREATE DATABASE article'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'article_db')\gexec
...
GRANT CONNECT ON DATABASE article_db TO migration_user;
GRANT CONNECT ON DATABASE article_db TO client_user;
