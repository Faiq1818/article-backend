...
// Params represents the parameters used to navigate through paginated datasets.
type Params struct {
	Page  int
	Limit int
}
...
func (p *Params) MakeMeta(total int) models.PaginationMeta {
